...
---
# 论文
###  1. Distributed Bayesian Learning with Stochastic Natural-gradient Expectation Propagation and the Posterior Server
\\(\sum\limits_{\alpha }^{{}}{\left[ \frac{\partial \theta }{\Xi \eta } \right]}\\)Leonard Hasenclever, Stefan Webb, Thibaut Lienart, Yee Whye Teh, Sebastian Vollmer, Balaji Lakshminarayanan, Charles Blundell <!--excerpt-->
